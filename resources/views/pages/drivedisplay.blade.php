            	...
            	<div class="col s12 m10 push-m1">
            		<div class="card grey lighten-3 content-card">
                        ...
                        <div class="card-action">
                             ...
                             <button class="btn waves-effect waves-light grey darken-2 no-shadow" type="submit" name="action" onClick="location.href='{{makeUrl('post_images')}}'">Access Post Image Drive</button>
                        </div>
                	</div>
                </div>
            </div>
                
            <form action="{{makeUrl('do_upload')}}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            {{ csrf_field() }}
            <div class="row">
            	<div class="col s12 m10 push-m1">
                	<div class="card grey lighten-3 content-card">
                ...
                @foreach($data as $row)
                	<tr>
                        ...
                        <td>
                          ...
                          <button class="btn waves-effect waves-light orange no-shadow" id="file_{{$row->id}}" onClick="delete_confirmation(this.id,'{{makeUrl('drive/delete/')}}')"><i class="material-icons">delete</i></button>
                        </td>
                    </tr>
                @endforeach
                </tbody>
